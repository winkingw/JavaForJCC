package com.utgaming.jcc.staticData.Constant;

public class MessageConstant {
    public static final String HEX_ROUND_1 = "2-1";
    ...
    public static final String CHOOSE_3 = "4-4";
    public static final String CHOOSE_4 = "5-4";
    public static final String CHOOSE_5 = "6-4";
    public static final String CHOOSE_6 = "7-4";

    public static final String WRONG_ROUND = "回合显示错误";
